...
## [2.2.8] - 2026-07-16
### Updated
- Rename generated `page` templates and directory to `screens` to align with architectural standards
...
## [2.2.5] - 2026-05-18
### Added
- Added more packages in pubspec.yaml file
...
## [2.2.3] - 2026-05-18
### Added
- Added --android, --ios, and --both flags to control which platforms to initialize in `setup` command
